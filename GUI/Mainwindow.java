      ...
      switch (i) {
        case 1: {
          ...
          button.setIcon(new ImageIcon(
              curve.getImage().getScaledInstance(button.getWidth(), button.getHeight(), Image.SCALE_SMOOTH)));
        ...
        case 2: {
          ...
          button.setIcon(new ImageIcon(
              clients.getImage().getScaledInstance(button.getWidth(), button.getHeight(), Image.SCALE_SMOOTH)));
        ...
        case 3: {
          ...
          button.setIcon(new ImageIcon(calibration.getImage().getScaledInstance(button.getWidth(), button.getHeight(),
        ...
        case 4: {
          ...
          button.setIcon(new ImageIcon(
              settings.getImage().getScaledInstance(button.getWidth(), button.getHeight(), Image.SCALE_SMOOTH)));
        ...
        default: {
          ...
          button.setIcon(new ImageIcon(
              backup.getImage().getScaledInstance(button.getWidth(), button.getHeight(), Image.SCALE_SMOOTH)));
